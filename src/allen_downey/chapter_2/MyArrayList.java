package allen_downey.chapter_2;
...
public class MyArrayList<T> implements List<T> {
    ...
    public T remove(int index) {
        ...
        T element = get(index); //запомнить предыдущий элемент.
        for (int i = index; i < size - 1; i++) {
            array[index] = array[i + 1];
        }
        size -= 1; //убавить длинну массива
        return element; //Returns the element that was removed from the list.
    }
